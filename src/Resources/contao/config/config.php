...
use gutesio\DataModelBundle\Resources\contao\models\GutesioDataChildPersonModel;
...
$GLOBALS['TL_MODELS']['tl_gutesio_data_child_person'] = GutesioDataChildPersonModel::class;
